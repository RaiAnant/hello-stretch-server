...
class TensorSubscriber (object):
    def __init__(self):
        ...
        rospy.Subscriber(HOME_PUBLISHER_TOPIC, Float64MultiArray, self._callback_home_data, queue_size=1)
        rospy.Subscriber(HOME_PARAMS_TOPIC, Float64MultiArray, self._callback_home_params, queue_size=1)
